    ...
    this.commonService.getPaymentsPerMonth().subscribe((res: any) => {
      if (res) {
        ...
        payments.forEach((payment) => {
          ...
          this.salesChartData.categories.push(
            this.monthToString[payment.month]
          );
        });
      }
    });
    this.commonService.getClientsPerMonth().subscribe((res: any) => {
      if (res) {
        ...
        clients.forEach((client) => {
          ...
          this.clientsChartData.categories.push(
            this.monthToString[client.month]
          );
        });
      }
    });
