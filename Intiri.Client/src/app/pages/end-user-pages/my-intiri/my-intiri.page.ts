...
export class MyIntiriPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.projectService.getAllProjects().subscribe((res) => {
      this.projects = res;
      console.log('Here are all projects', res);
  ...
  getNumberOfBlankSlot(project) {
    const n = 4 - project.projectMoodboards.length;
    return n < 0 ? 0 : n;
  }

  addInspiration() {
    this.projectService
      .addInspiration(this.newInspiration)
      .subscribe((_: any[]) => {
        this.projectService.getInspirations();
