...
export class MoodboardService {
  ...
  getMoodboards() {
    return this.http
      .get<Moodboard[]>(this.apiUrl + 'moodboards')
      .pipe(
        map((mbs) => {
          if (mbs) {
  ...
  getMoodboardOffers() {
    return this.http.get<Moodboard[]>(
      this.apiUrl + 'moodboards/client/moodboardOffers'
    );
  }
  ...
  updateMoodboard(moodboard: Moodboard) {
    return this.http.post<Moodboard>(
      this.apiUrl + 'moodboards/addMoodboard',
      moodboard
    );
  }
  ...
  addMoodboardOffer(moodboard, consultationPaymentId) {
    const req_data = {
      moodboardOffer: this.parseMoodboard(moodboard),
      consultationPaymentId,
    };
    return this.http.post(
      this.apiUrl + 'moodboards/addMoodboardOffer',
      req_data
    );
  }
