...
export class CraftsmanService {
  ...
  craftsmanPages = {
    ...
    dinningroom: 'https://prosjekt.luado.no/project-types/139/?utm_source=intiri&utm_medium=affiliate&utm_campaign=moodboard',
  ...
  getCraftsmanUrl(roomIndex: any){
    return this.craftsmanPages[roomIndex] ? this.craftsmanPages[roomIndex] : this.craftsmanPages['default'];
  }
}
