...
namespace Intiri.API.DataAccess
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IConsultationPaymentRepository ConsultationPaymentRepository =>
            _consultationPaymentRepository;
        ...
        public IDesignerPortfolioRepository DesignerPortfolioRepository =>
            _designerPortfolioRepository;
