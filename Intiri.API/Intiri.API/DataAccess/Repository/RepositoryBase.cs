...
namespace Intiri.API.DataAccess.Repository
{
	public class RepositoryBase<TEntity> : IRepositoryBase<TEntity> where TEntity : class
	{
		...
		public async Task<IEnumerable<TProjectedEntity>> Get<TProjectedEntity>(Expression<Func<TEntity, TProjectedEntity>> projection,
		...
		public IQueryable<TProjectedEntity> GetIQueryable<TProjectedEntity>(Expression<Func<TEntity, TProjectedEntity>> projection,
								 Expression<Func<TEntity, bool>> filter = null,
								 Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy = null)
		{
		...
		public async Task<IEnumerable<TProjectedEntity>> Get<TProjectedEntity>(IMapper mapper,
								Expression<Func<TEntity, bool>> filter = null,
								Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy = null)
		{
		...
		public IQueryable<TProjectedEntity> GetIQueryable<TProjectedEntity>(IMapper mapper,
								Expression<Func<TEntity, bool>> filter = null,
								Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy = null)
		{
		...
		public async Task<TProjectedEntity> SingleOrDefaultAsync<TProjectedEntity>(Expression<Func<TEntity, bool>> predicate,
									IMapper mapper)
		{
			ArgumentNullException.ThrowIfNull(predicate, nameof(predicate));
			ArgumentNullException.ThrowIfNull(mapper, nameof(mapper));
		...
		public async Task<TProjectedEntity> SingleOrDefaultAsync<TProjectedEntity>(Expression<Func<TEntity, TProjectedEntity>> projection,
		...
		private IQueryable<TEntity> Filter(Expression<Func<TEntity, bool>> filter, IQueryable<TEntity> query)
		{
			if (filter != null)
			{
		...
		private IQueryable<TEntity> OrderBy(Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy, IQueryable<TEntity> query)
		{
			if (orderBy != null)
			{
				query = orderBy(query);
