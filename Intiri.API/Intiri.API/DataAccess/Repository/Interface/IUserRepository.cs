...
namespace Intiri.API.DataAccess.Repository.Interface
{
    ...
    {
        Task<int> GetUsersCountAsync<TEntity>()
            where TEntity : class;
        Task<IEnumerable<TEntity>> GetUsersAsync<TEntity>()
            where TEntity : class;
        Task<TEntity> GetUserByIdAsync<TEntity>(int id)
            where TEntity : User;
        Task<TEntity> GetUserUsernameIdAsync<TEntity>(string username)
            where TEntity : User;
