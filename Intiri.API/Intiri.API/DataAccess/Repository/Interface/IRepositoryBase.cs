...
namespace Intiri.API.DataAccess.Repository.Interface
{
	public interface IRepositoryBase<TEntity>
	{
		...
		/// <param name="filter">Filter predicate that accepts TEntity and returns bool</param>
		/// <param name="orderBy">OrderBy expresion that accepts IQueryable<TEntity> and returns IOrderedQueryable<TEntity></param>
		Task<IEnumerable<TProjectedEntity>> Get<TProjectedEntity>(Expression<Func<TEntity, TProjectedEntity>> projection,
								 Expression<Func<TEntity, bool>> filter = null,
								 Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy = null);

		IQueryable<TProjectedEntity> GetIQueryable<TProjectedEntity>(Expression<Func<TEntity, TProjectedEntity>> projection,
								 Expression<Func<TEntity, bool>> filter = null,
								 Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy = null);
		...
		/// <param name="filter">Filter predicate that accepts TEntity and returns bool</param>
		/// <param name="orderBy">OrderBy expresion that accepts IQueryable<TEntity> and returns IOrderedQueryable<TEntity></param>
		Task<IEnumerable<TProjectedEntity>> Get<TProjectedEntity>(IMapper mapper,
								 Expression<Func<TEntity, bool>> filter = null,
								 Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy = null);

		IQueryable<TProjectedEntity> GetIQueryable<TProjectedEntity>(IMapper mapper,
								Expression<Func<TEntity, bool>> filter = null,
								Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy = null);
		...
		/// <param name="predicate">Predicate expression to check entities against</param>
		/// <param name="mapper">IMapper instance used for projection</param>
		Task<TProjectedEntity> SingleOrDefaultAsync<TProjectedEntity>(Expression<Func<TEntity, bool>> predicate,
								 IMapper mapper);

		Task<TProjectedEntity> SingleOrDefaultAsync<TProjectedEntity>(Expression<Func<TEntity, TProjectedEntity>> projection,
