    ...
    public partial class ProjectAndMoodboard : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_ProjectStyleImage",
                        x => new { x.ProjectsId, x.StyleImagesId }
                    );
                    table.ForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "Moodboards");

            migrationBuilder.DropTable(name: "ProjectStyleImage");

            migrationBuilder.DropTable(name: "RoomDetails");
