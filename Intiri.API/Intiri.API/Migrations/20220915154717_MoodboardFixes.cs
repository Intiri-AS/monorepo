    ...
    public partial class MoodboardFixes : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoodboardColorPallete", x => new { x.ColorPalletesId, x.MoodboardsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoodboardMaterial", x => new { x.MaterialsId, x.MoodboardsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoodboardProduct", x => new { x.MoodboardsId, x.ProductsId });
                    table.ForeignKey(
