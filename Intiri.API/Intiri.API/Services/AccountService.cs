...
namespace Intiri.API.Services
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<SignInResult> CheckUserSignInPaswordAsync(
            User user,
            string password,
        ...
        public async Task<IdentityResult> UserResetPaswordAsync(
            User user,
            string token,
            string password
        )
        ...
        public async Task<IEnumerable<TEntity>> GetAllUsersAsync<TEntity>()
            where TEntity : class
        {
