...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [5836],
  {
    5836: (C, g, e) => {
      ...
      const r = class {
        constructor(t) {
          (0, o.r)(this, t), (this.edge = !1), (this.activated = !1);
        }
        activatedChanged() {
        ...
        render() {
          const { horizontal: t, vertical: n, edge: s } = this,
            c = (0, d.b)(this);
          return (0, o.h)(
            o.H,
            {
        ...
        render() {
          ...
          return (0, o.h)(
            o.H,
            {
              ...
              class: (0, b.c)(s, {
                [_]: !0,
                "fab-button-in-list": y,
                "fab-button-translucent-in-list": y && k,
                "fab-button-close-active": x,
                "fab-button-show": E,
                "fab-button-disabled": n,
                "fab-button-translucent": k,
                "ion-activatable": !0,
                "ion-focusable": !0,
                [`fab-button-${w}`]: void 0 !== w,
              }),
            },
            (0, o.h)(
              z,
              Object.assign(
                ...
                O,
                {
                  ...
                  onBlur: this.onBlur,
                  onClick: (A) =>
                    (0, b.o)(c, A, this.routerDirection, this.routerAnimation),
                },
                D
              ),
              (0, o.h)("ion-icon", {
              ...
              "md" === _ && (0, o.h)("ion-ripple-effect", null)
            )
          );
        }
        get el() {
      ...
      const l = class {
        ...
        activatedChanged(t) {
          const n = Array.from(this.el.querySelectorAll("ion-fab-button")),
            s = t ? 30 : 0;
          n.forEach((c, x) => {
            setTimeout(() => (c.show = t), x * s);
          });
        }
        render() {
          const t = (0, d.b)(this);
    ...
    2854: (C, g, e) => {
      ...
      const o = (r, i) => null !== i.closest(r),
        ...
        b = /^[a-z][a-z0-9+\-.]*:/,
        v = (function () {
          var r = (0, u.Z)(function* (i, a, p, f) {
            if (null != i && "#" !== i[0] && !b.test(i)) {
              const l = document.querySelector("ion-router");
              if (l) return a?.preventDefault(), l.push(i, p, f);
            }
            return !1;
          });
          return function (a, p, f, l) {
