...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    7544: (A, u, d) => {
      d.r(u), d.d(u, { ion_breadcrumb: () => r, ion_breadcrumbs: () => m });
      var o = d(1308),
        h = d(3938),
        g = d(9658),
        x = d(5730),
      ...
      const r = class {
        constructor(l) {
          (0, o.r)(this, l),
            ...
            (this.collapsedClick = (0, o.e)(this, "collapsedClick", 7)),
        ...
        render() {
          const {
              ...
              routerDirection: M,
              separator: O,
              showCollapsedIndicator: y,
              target: z,
            } = this,
            _ = this.isClickable(),
            B = void 0 === this.href ? "span" : "a",
            I = n ? void 0 : this.href,
            E = (0, g.b)(this),
            D = "span" === B ? {} : { download: c, href: I, target: z },
            j = !p && (i ? !(!y || p) : O);
          return (0, o.h)(
            o.H,
            {
              onClick: (C) => (0, b.o)(I, C, M, w),
              ...
              class: (0, b.c)(l, {
                ...
                "in-breadcrumbs-color": (0, b.h)("ion-breadcrumbs[color]", f),
            ...
            y &&
              (0, o.h)(
                "button",
                {
                  ...
                  ref: (C) => (this.collapsedRef = C),
                  class: { "breadcrumbs-collapsed-indicator": !0 },
                },
                (0, o.h)("ion-icon", { icon: h.n, lazy: !1 })
              ),
            j &&
              (0, o.h)(
                "span",
      ...
      const m = class {
        constructor(l) {
          (0, o.r)(this, l),
            ...
            (this.resetActiveBreadcrumb = () => {
              const i = this.getBreadcrumbs().find((n) => n.active);
              i && this.activeChanged && (i.active = !1);
            }),
            (this.setMaxItems = () => {
              const {
                  itemsAfterCollapse: a,
                  itemsBeforeCollapse: i,
                  maxItems: n,
                } = this,
                c = this.getBreadcrumbs();
              for (const t of c)
                (t.showCollapsedIndicator = !1), (t.collapsed = !1);
              void 0 !== n &&
                c.length > n &&
                i + a <= n &&
                c.forEach((t, p) => {
                  p === i && (t.showCollapsedIndicator = !0),
                    p >= i && p < c.length - a && (t.collapsed = !0);
                });
            }),
            (this.setBreadcrumbSeparator = () => {
              ...
              for (const t of c) {
                const p =
                  void 0 !== n && 0 === a ? t === c[i] : t === c[c.length - 1];
                (t.last = p),
                  (t.separator =
                    void 0 !== t.separator ? t.separator : !p || void 0),
                  !f && p && ((t.active = !0), (this.activeChanged = !0));
              }
            }),
            (this.getBreadcrumbs = () =>
        ...
        onCollapsedClick(l) {
          const i = this.getBreadcrumbs().filter((n) => n.collapsed);
          this.ionCollapsedClick.emit(
            Object.assign(Object.assign({}, l.detail), {
              collapsedBreadcrumbs: i,
            })
          );
        }
        maxItemsChanged() {
        ...
        render() {
          const { color: l, collapsed: a } = this,
            i = (0, g.b)(this);
          return (0, o.h)(
            o.H,
            {
    ...
    2854: (A, u, d) => {
      d.d(u, { c: () => g, g: () => b, h: () => h, o: () => k });
      var o = d(5861);
      const h = (r, e) => null !== e.closest(r),
        g = (r, e) =>
          "string" == typeof r && r.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${r}`]: !0 }, e)
            : e,
        b = (r) => {
          const e = {};
          return (
        ...
        v = /^[a-z][a-z0-9+\-.]*:/,
        k = (function () {
          var r = (0, o.Z)(function* (e, s, m, l) {
            if (null != e && "#" !== e[0] && !v.test(e)) {
              const a = document.querySelector("ion-router");
              if (a) return s?.preventDefault(), a.push(e, m, l);
            }
            return !1;
          });
          return function (s, m, l, a) {
