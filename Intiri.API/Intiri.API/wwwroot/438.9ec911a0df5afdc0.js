...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    438: (k, b, r) => {
      r.r(b), r.d(b, { ion_tab_bar: () => n, ion_tab_button: () => d });
      var e = r(1308),
        l = r(9658),
        h = r(9852),
        g = r(2854);
      ...
      const n = class {
        constructor(t) {
          (0, e.r)(this, t),
            (this.ionTabBarChanged = (0, e.e)(this, "ionTabBarChanged", 7)),
        ...
        render() {
          const { color: t, translucent: o, keyboardVisible: s } = this,
            f = (0, l.b)(this),
            c = s && "top" !== this.el.getAttribute("slot");
          return (0, e.h)(
            e.H,
            {
              role: "tablist",
      ...
      const d = class {
        constructor(t) {
          (0, e.r)(this, t),
            (this.ionTabButtonClick = (0, e.e)(this, "ionTabButtonClick", 7)),
            (this.disabled = !1),
            (this.selected = !1),
            (this.onKeyUp = (o) => {
        ...
        render() {
          ...
          return (0, e.h)(
            e.H,
            {
              ...
              role: "tab",
              tabindex: f,
              "aria-selected": m ? "true" : null,
              id: void 0 !== y ? `tab-button-${y}` : null,
              class: {
                [v]: !0,
                "tab-selected": m,
                "tab-disabled": t,
                "tab-has-label": s,
                "tab-has-icon": o,
                "tab-has-label-only": s && !o,
                "tab-has-icon-only": o && !s,
                [`tab-layout-${z}`]: !0,
                "ion-activatable": !0,
                "ion-selectable": !0,
                "ion-focusable": !0,
            ...
            (0, e.h)(
              ...
              Object.assign(
                {},
                { download: this.download, href: c, rel: w, target: _ },
                { tabIndex: -1, class: "button-native", part: "native" }
              ),
              (0, e.h)(
                "span",
                { class: "button-inner" },
              ...
              "md" === v && (0, e.h)("ion-ripple-effect", { type: "unbounded" })
            )
          );
        }
        get el() {
    ...
    2854: (k, b, r) => {
      r.d(b, { c: () => h, g: () => x, h: () => l, o: () => u });
      var e = r(5861);
      const l = (n, i) => null !== i.closest(n),
        h = (n, i) =>
        ...
        p = /^[a-z][a-z0-9+\-.]*:/,
        u = (function () {
          var n = (0, e.Z)(function* (i, a, d, t) {
            if (null != i && "#" !== i[0] && !p.test(i)) {
              const o = document.querySelector("ion-router");
              if (o) return a?.preventDefault(), o.push(i, d, t);
            }
            return !1;
          });
          return function (a, d, t, o) {
