...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [4753],
  {
    ...
    2854: (b, s, a) => {
      a.d(s, { c: () => p, g: () => c, h: () => d, o: () => h });
      var o = a(5861);
      const d = (r, t) => null !== t.closest(r),
        p = (r, t) =>
          "string" == typeof r && r.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${r}`]: !0 }, t)
            : t,
        c = (r) => {
          const t = {};
          return (
        ...
        l = /^[a-z][a-z0-9+\-.]*:/,
        h = (function () {
          var r = (0, o.Z)(function* (t, n, e, i) {
            if (null != t && "#" !== t[0] && !l.test(t)) {
              const u = document.querySelector("ion-router");
              if (u) return n?.preventDefault(), u.push(t, e, i);
            }
            return !1;
          });
