...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    3648: (C, p, a) => {
      a.r(p), a.d(p, { ion_action_sheet: () => w });
      var b = a(5861),
        o = a(1308),
        m = a(9658),
        x = a(3245),
      ...
      const v = (t) => {
        ...
        w = class {
          constructor(t) {
            (0, o.r)(this, t),
              (this.didPresent = (0, o.e)(this, "ionActionSheetDidPresent", 7)),
              (this.willPresent = (0, o.e)(
                this,
                "ionActionSheetWillPresent",
                7
              )),
              (this.willDismiss = (0, o.e)(
                this,
                "ionActionSheetWillDismiss",
                7
              )),
              (this.didDismiss = (0, o.e)(this, "ionActionSheetDidDismiss", 7)),
              (this.presented = !1),
              ...
              (this.dispatchCancelHandler = (e) => {
                if ((0, h.i)(e.detail.role)) {
                  const n = this.getButtons().find((k) => "cancel" === k.role);
                  this.callButtonHandler(n);
                }
              });
          }
          present() {
            return (0, h.d)(this, "actionSheetEnter", v, D);
          }
          connectedCallback() {
            (0, h.e)(this.el);
          }
          dismiss(t, e) {
            return (0, h.f)(this, t, e, "actionSheetLeave", g, A);
          }
          onDidDismiss() {
            return (0, h.g)(this.el, "ionActionSheetDidDismiss");
          }
          onWillDismiss() {
            return (0, h.g)(this.el, "ionActionSheetWillDismiss");
          }
          buttonClick(t) {
            var e = this;
          ...
          callButtonHandler(t) {
            return (0, b.Z)(function* () {
              return !(t && !1 === (yield (0, h.s)(t.handler)));
            })();
          }
          getButtons() {
            ...
            this.gesture ||
              ...
              (0, o.f)(() => {
                t.scrollHeight > t.clientHeight ||
                  ((this.gesture = (0, x.c)(e, (n) =>
                    n.classList.contains("action-sheet-button")
                  )),
          ...
          render() {
            const { header: t, htmlAttributes: e, overlayIndex: i } = this,
              n = (0, m.b)(this),
              k = this.getButtons(),
              u = k.find((d) => "cancel" === d.role),
              z = k.filter((d) => "cancel" !== d.role),
              E = `action-sheet-${i}-header`;
            return (0, o.h)(
              o.H,
              Object.assign(
                {
                  role: "dialog",
                  "aria-modal": "true",
                  "aria-labelledby": void 0 !== t ? E : null,
                  tabindex: "-1",
                },
                e,
                {
                  ...
                  class: Object.assign(
                    Object.assign({ [n]: !0 }, (0, f.g)(this.cssClass)),
                    {
                      "overlay-hidden": !0,
                  ...
                  (0, o.h)(
                    ...
                    z.map((d) =>
                      (0, o.h)(
                        ...
                        "md" === n && (0, o.h)("ion-ripple-effect", null)
                      )
                    )
                  ),
                  u &&
    ...
    2854: (C, p, a) => {
      ...
      const o = (r, s) => null !== s.closest(r),
        ...
        f = /^[a-z][a-z0-9+\-.]*:/,
        c = (function () {
          var r = (0, b.Z)(function* (s, l, y, v) {
            if (null != s && "#" !== s[0] && !f.test(s)) {
              const g = document.querySelector("ion-router");
              if (g) return l?.preventDefault(), g.push(s, y, v);
            }
            return !1;
          });
          return function (l, y, v, g) {
