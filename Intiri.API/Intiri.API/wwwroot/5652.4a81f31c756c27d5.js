...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [5652],
  {
    4147: (C, g, c) => {
      c.d(g, { a: () => p, b: () => v, p: () => i });
      const i = (u, ...d) => console.warn(`[Ionic Warning]: ${u}`, ...d),
        v = (u, ...d) => console.error(`[Ionic Error]: ${u}`, ...d),
        p = (u, ...d) =>
          console.error(
            `<${u.tagName.toLowerCase()}> must be used inside ${d.join(
              " or "
            )}.`
          );
    },
    5652: (C, g, c) => {
      c.r(g), c.d(g, { ion_button: () => z, ion_icon: () => A });
      var i = c(1308),
        v = c(9658),
        p = c(5730),
        u = c(4147),
      ...
      const l = (o, t, n, r, e) => (
          ...
          r && "ios" === n
            ...
            : e && "md" === n
            ? (o = y(e))
            : (!o && t && !w(t) && (o = t), b(o) && (o = y(o))),
          b(o) && "" !== o.trim() && "" === o.replace(/[a-z]|-|\d/gi, "")
            ? o
            : null
        ),
        f = (o) => (b(o) && ((o = o.trim()), w(o)) ? o : null),
        w = (o) => o.length > 0 && /(\/|\.)/.test(o),
        b = (o) => "string" == typeof o,
        y = (o) => o.toLowerCase(),
        z = class {
          constructor(o) {
            (0, i.r)(this, o),
              (this.ionFocus = (0, i.e)(this, "ionFocus", 7)),
              (this.ionBlur = (0, i.e)(this, "ionBlur", 7)),
              (this.inItem = !1),
              (this.inListHeader = !1),
              (this.inToolbar = !1),
          ...
          componentWillLoad() {
            (this.inToolbar = !!this.el.closest("ion-buttons")),
              ...
              (this.inheritedAttributes = (0, p.i)(this.el));
          }
          get hasIconOnly() {
          ...
          render() {
            const o = (0, v.b)(this),
              ...
              D = void 0 === L && this.inItem ? "small" : L,
              $ = void 0 === M ? "button" : "a",
              X =
                "button" === $
                  ? { type: n }
                  : { download: this.download, href: M, rel: e, target: h };
            let _ = this.fill;
            return (
              void 0 === _ &&
              ...
              (0, i.h)(
                ...
                (0, i.h)(
                  ...
                  (0, i.h)(
                    "span",
                    { class: "button-inner" },
                    (0, i.h)("slot", { name: "icon-only" }),
                    (0, i.h)("slot", { name: "start" }),
                    (0, i.h)("slot", null),
                    (0, i.h)("slot", { name: "end" })
                  ),
                  "md" === o &&
                    (0, i.h)("ion-ripple-effect", { type: this.rippleType })
                )
              )
            );
          }
      ...
      const E = (o) => {
        ...
        A = class {
          ...
          componentWillLoad() {
            this.inheritedAttributes = ((o, t = []) => {
              ...
              return (
                t.forEach((r) => {
                  o.hasAttribute(r) &&
                    (null !== o.getAttribute(r) && (n[r] = o.getAttribute(r)),
                    o.removeAttribute(r));
                }),
                n
              );
                  ...
                  : ((o, t) => {
                      ...
                      if (!n) {
                        if (!(typeof fetch < "u" && typeof document < "u"))
                          return m.set(o, ""), Promise.resolve();
                        (n = fetch(o).then((r) => {
                          if (r.ok)
                            return r.text().then((e) => {
                              e &&
                                ...
                                (e = ((o) => {
                                  ...
                                  t.innerHTML = o;
                                  for (
                                    let r = t.childNodes.length - 1;
                                    r >= 0;
                                    r--
                                  )
                                    "svg" !==
                                      t.childNodes[r].nodeName.toLowerCase() &&
                                      t.removeChild(t.childNodes[r]);
                      ...
                      return n;
                    })(t, this.sanitize).then(
                      () => (this.svgContent = m.get(t))
                    ));
            }
            const o = (this.iconName = l(
              this.name,
              this.icon,
              this.mode,
              this.ios,
          ...
          render() {
            const { iconName: o, ariaLabel: t, inheritedAttributes: n } = this,
              r = this.mode || "md",
              e =
                this.flipRtl ||
                (o &&
                  (o.indexOf("arrow") > -1 || o.indexOf("chevron") > -1) &&
                  !1 !== this.flipRtl);
            return (0, i.h)(
              i.H,
              Object.assign(
                {
                  "aria-label": void 0 === t || this.hasAriaHidden() ? null : t,
                  role: "img",
                  class: Object.assign(
                    Object.assign({ [r]: !0 }, W(this.color)),
                    {
        ...
        U = () =>
          ...
          "md",
        W = (o) => (o ? { "ion-color": !0, [`ion-color-${o}`]: !0 } : null);
      A.style =
    ...
    2854: (C, g, c) => {
      ...
      const v = (a, s) => null !== s.closest(a),
        ...
        k = /^[a-z][a-z0-9+\-.]*:/,
        x = (function () {
          var a = (0, i.Z)(function* (s, l, f, w) {
            if (null != s && "#" !== s[0] && !k.test(s)) {
              const b = document.querySelector("ion-router");
              if (b) return l?.preventDefault(), b.push(s, f, w);
            }
            return !1;
          });
          return function (l, f, w, b) {
