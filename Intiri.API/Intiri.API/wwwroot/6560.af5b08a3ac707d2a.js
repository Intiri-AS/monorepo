  ...
  [6560],
  {
    6560: (f, d, o) => {
      ...
      const e = class {
          ...
          (0, a.r)(this, t),
            ...
            (this.onInput = (n) => {
              this.nativeInput && (this.value = this.nativeInput.value),
                this.emitStyle(),
                this.ionInput.emit(n);
            }),
            (this.onFocus = (n) => {
              (this.hasFocus = !0),
                this.focusChange(),
                this.fireFocusEvents && this.ionFocus.emit(n);
            }),
            (this.onBlur = (n) => {
              (this.hasFocus = !1),
                this.focusChange(),
                this.fireFocusEvents && this.ionBlur.emit(n);
            }),
            (this.onKeyDown = () => {
        ...
        debounceChanged() {
          this.ionChange = (0, s.h)(this.ionChange, this.debounce);
        }
        disabledChanged() {
          this.emitStyle();
        }
        ...
        componentWillLoad() {
          this.inheritedAttributes = Object.assign(
            Object.assign({}, (0, s.i)(this.el)),
            (0, s.j)(this.el, ["data-form-type", "title"])
          );
        }
        componentDidLoad() {
          this.runAutoGrow();
          ...
          return (
            ...
            (0, a.h)(
              a.H,
              {
                ...
                class: (0, p.c)(this.color, { [t]: !0 }),
              },
              (0, a.h)(
                "div",
                {
                  class: "textarea-wrapper",
                  ref: (m) => (this.textareaWrapper = m),
                },
                (0, a.h)(
                  "textarea",
                  Object.assign(
                    {
                      ...
                      "aria-labelledby": r ? l : null,
                      ref: (m) => (this.nativeInput = m),
    ...
    2854: (f, d, o) => {
      ...
      const a = (e, i) => null !== i.closest(e),
        ...
        g = /^[a-z][a-z0-9+\-.]*:/,
        u = (function () {
          var e = (0, h.Z)(function* (i, t, n, l) {
            if (null != i && "#" !== i[0] && !g.test(i)) {
              const r = document.querySelector("ion-router");
              if (r) return t?.preventDefault(), r.push(i, n, l);
            }
            return !1;
          });
          return function (t, n, l, r) {
