...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [2073],
  {
      ...
      const n = class {
        constructor(t) {
          ...
          (0, r.r)(this, t),
            ...
            (this.onClick = (function () {
              var d = (0, u.Z)(function* (s) {
                const g = a.el.closest("ion-nav");
                return (
                  s.preventDefault(),
                  g && (yield g.canGoBack())
                    ? g.pop({
                    ...
                    : (0, c.o)(a.defaultHref, s, "back", a.routerAnimation)
                );
              });
              return function (s) {
        ...
        componentWillLoad() {
          (this.inheritedAttributes = (0, h.i)(this.el)),
            void 0 === this.defaultHref &&
              (this.defaultHref = e.c.get("backButtonDefaultHref"));
        }
        get backButtonIcon() {
          return (
            this.icon ??
            ("ios" === (0, e.b)(this)
              ? e.c.get("backButtonIcon", p.c)
              : e.c.get("backButtonIcon", p.a))
          );
        }
        get backButtonText() {
          const t = "ios" === (0, e.b)(this) ? "Back" : null;
          return null != this.text ? this.text : e.c.get("backButtonText", t);
        }
        get hasIconOnly() {
        ...
        render() {
          const {
              ...
              backButtonText: m,
              icon: w,
              inheritedAttributes: x,
            } = this,
            y = void 0 !== a,
            f = (0, e.b)(this),
            _ = x["aria-label"] || m || "back";
          return (0, r.h)(
            r.H,
            {
              ...
              class: (0, c.c)(t, {
                [f]: !0,
                button: !0,
                "back-button-disabled": d,
                "back-button-has-icon-only": g,
            ...
            (0, r.h)(
              ...
              "md" === f &&
                (0, r.h)("ion-ripple-effect", { type: this.rippleType })
            )
          );
        }
        get el() {
    ...
    2854: (k, l, o) => {
      o.d(l, { c: () => p, g: () => h, h: () => r, o: () => b });
      var u = o(5861);
      const r = (i, n) => null !== n.closest(i),
        p = (i, n) =>
          "string" == typeof i && i.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${i}`]: !0 }, n)
            : n,
        h = (i) => {
          const n = {};
          return (
        ...
        c = /^[a-z][a-z0-9+\-.]*:/,
        b = (function () {
          var i = (0, u.Z)(function* (n, t, a, d) {
            if (null != n && "#" !== n[0] && !c.test(n)) {
              const s = document.querySelector("ion-router");
              if (s) return t?.preventDefault(), s.push(n, a, d);
            }
            return !1;
          });
