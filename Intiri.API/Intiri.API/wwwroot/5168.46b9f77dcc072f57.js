...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [5168],
  {
      ...
      const g = class {
          constructor(t) {
            (0, n.r)(this, t),
              ...
              (this.ionFocus = (0, n.e)(this, "ionFocus", 7)),
              (this.ionBlur = (0, n.e)(this, "ionBlur", 7)),
              (this.ionStyle = (0, n.e)(this, "ionStyle", 7)),
              (this.inputId = "ion-tg-" + h++),
              (this.lastDrag = 0),
              (this.activated = !1),
              ...
              (this.getSwitchLabelIcon = (r, a) =>
                "md" === r ? (a ? d.f : d.r) : a ? d.r : d.g);
          }
          checkedChanged(t) {
          ...
          onMove(t) {
            u((0, k.i)(this.el), this.checked, t.deltaX, -10) &&
              ((this.checked = !this.checked), (0, x.c)());
          }
          onEnd(t) {
            (this.activated = !1),
          ...
          renderOnOffSwitchLabels(t, r) {
            const a = this.getSwitchLabelIcon(t, r);
            return (0, n.h)("ion-icon", {
              class: {
                "toggle-switch-icon": !0,
                "toggle-switch-icon-checked": r,
              },
              icon: a,
            });
          }
          render() {
            const {
              ...
              c = (0, f.b)(this),
              { label: C, labelId: O, labelText: D } = (0, b.d)(w, v),
              I = this.getValue();
            return (
              (0, b.e)(!0, w, E, a ? I : "", l),
              (0, n.h)(
                n.H,
                {
                  ...
                  "aria-labelledby": C ? O : null,
                  "aria-checked": `${a}`,
                  "aria-hidden": l ? "true" : null,
                  role: "switch",
                  class: (0, e.c)(r, {
                    [c]: !0,
                    "in-item": (0, e.h)("ion-item", w),
                    "toggle-activated": t,
                    "toggle-checked": a,
                    "toggle-disabled": l,
                    interactive: !0,
                ...
                (0, n.h)(
                  ...
                  _ &&
                    "ios" === c && [
                      this.renderOnOffSwitchLabels(c, !0),
                      this.renderOnOffSwitchLabels(c, !1),
                    ],
                  (0, n.h)(
                    "div",
                    ...
                    (0, n.h)(
                      ...
                      _ && "md" === c && this.renderOnOffSwitchLabels(c, a)
                    )
                  )
                ),
                (0, n.h)("label", { htmlFor: v }, D),
                (0, n.h)("input", {
                  type: "checkbox",
                  role: "switch",
                  "aria-checked": `${a}`,
    ...
    2854: (y, p, o) => {
      o.d(p, { c: () => d, g: () => b, h: () => n, o: () => k });
      var m = o(5861);
      const n = (e, i) => null !== i.closest(e),
        d = (e, i) =>
        ...
        x = /^[a-z][a-z0-9+\-.]*:/,
        k = (function () {
          var e = (0, m.Z)(function* (i, s, g, u) {
            if (null != i && "#" !== i[0] && !x.test(i)) {
              const h = document.querySelector("ion-router");
              if (h) return s?.preventDefault(), h.push(i, g, u);
            }
            return !1;
          });
          return function (s, g, u, h) {
