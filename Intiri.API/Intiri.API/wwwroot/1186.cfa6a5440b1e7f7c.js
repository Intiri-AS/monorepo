...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [1186],
  {
    4147: (T, u, l) => {
      l.d(u, { a: () => f, b: () => i, p: () => p });
      const p = (d, ...h) => console.warn(`[Ionic Warning]: ${d}`, ...h),
        i = (d, ...h) => console.error(`[Ionic Error]: ${d}`, ...h),
        f = (d, ...h) =>
          console.error(
            `<${d.tagName.toLowerCase()}> must be used inside ${h.join(
              " or "
            )}.`
          );
    },
    3583: (T, u, l) => {
      l.r(u), l.d(u, { ion_reorder: () => I, ion_reorder_group: () => b });
      var p = l(5861),
        i = l(1308),
        f = l(3938),
        d = l(9658),
      ...
      const I = class {
        ...
        onClick(t) {
          ...
          t.preventDefault(),
            (!e || !e.disabled) && t.stopImmediatePropagation();
        }
        render() {
          const t = (0, d.b)(this);
          return (0, i.h)(
      ...
      const b = class {
          constructor(t) {
            (0, i.r)(this, t),
              (this.ionItemReorder = (0, i.e)(this, "ionItemReorder", 7)),
              (this.lastToIndex = -1),
              (this.cachedHeights = []),
              (this.scrollElTop = 0),
            ...
            return (0, p.Z)(function* () {
              ...
              e && (t.scrollEl = yield (0, h.g)(e)),
                (t.gesture = (yield Promise.resolve().then(
                  ...
                  direction: "y",
                  passive: !1,
                  canStart: (s) => t.canStart(s),
                  onStart: (s) => t.onStart(s),
                  onMove: (s) => t.onMove(s),
                  onEnd: () => t.onEnd(),
                })),
                t.disabledChanged();
          ...
          onStart(t) {
            ...
            for (let a = 0; a < o.length; a++) {
              const m = o[a];
              (c += m.offsetHeight), s.push(c), (m.$ionIndex = a);
            }
            ...
            if (
              ...
              const a = this.scrollEl.getBoundingClientRect();
              (this.scrollElInitial = this.scrollEl.scrollTop),
                (this.scrollElTop = a.top + _),
                (this.scrollElBottom = a.bottom - _);
            } else
              (this.scrollElInitial = 0),
                (this.scrollElTop = 0),
                (this.scrollElBottom = 0);
            (this.lastToIndex = E(e)),
          ...
          onMove(t) {
            ...
            const s = this.autoscroll(t.currentY),
              ...
              c = Math.max(r, Math.min(t.currentY, this.containerBottom - s)),
              n = s + c - t.startY,
              m = this.itemIndexForTop(c - r);
            if (m !== this.lastToIndex) {
              const R = E(e);
              (this.lastToIndex = m), (0, g.b)(), this.reorderMove(R, m);
            }
          ...
          completeSync(t) {
            ...
            if (e && 2 === this.state) {
              ...
              o === c ||
                (void 0 !== t && !0 !== t) ||
                this.el.insertBefore(e, c < o ? s[o + 1] : s[o]),
                Array.isArray(t) && (t = P(t, c, o));
