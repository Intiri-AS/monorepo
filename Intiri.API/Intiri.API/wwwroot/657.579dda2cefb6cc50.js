...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    657: (m, e, n) => {
      n.r(e), n.d(e, { ion_chip: () => s });
      var o = n(1308),
        l = n(9658),
        g = n(2854);
      const s = class {
        constructor(a) {
          (0, o.r)(this, a), (this.outline = !1), (this.disabled = !1);
        }
        render() {
          const a = (0, l.b)(this);
          return (0, o.h)(
    ...
    2854: (m, e, n) => {
      n.d(e, { c: () => g, g: () => s, h: () => l, o: () => h });
      var o = n(5861);
      const l = (t, r) => null !== r.closest(t),
        g = (t, r) =>
        ...
        a = /^[a-z][a-z0-9+\-.]*:/,
        h = (function () {
          var t = (0, o.Z)(function* (r, i, c, b) {
            if (null != r && "#" !== r[0] && !a.test(r)) {
              const p = document.querySelector("ion-router");
              if (p) return i?.preventDefault(), p.push(r, c, b);
            }
            return !1;
          });
          return function (i, c, b, p) {
