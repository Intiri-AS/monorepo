...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [2773],
  {
    2773: (M, _, h) => {
      ...
      const a = (e, t) =>
          1 !== e.nodeType
            ...
            : (e.tagName === t.toUpperCase()
              ...
              ).find((n) => n.value === e.value),
        C = class {
          constructor(e) {
            (0, s.r)(this, e),
              (this.ionChange = (0, s.e)(this, "ionChange", 7)),
              (this.ionCancel = (0, s.e)(this, "ionCancel", 7)),
              (this.ionDismiss = (0, s.e)(this, "ionDismiss", 7)),
              (this.ionFocus = (0, s.e)(this, "ionFocus", 7)),
              (this.ionBlur = (0, s.e)(this, "ionBlur", 7)),
              (this.ionStyle = (0, s.e)(this, "ionStyle", 7)),
              (this.inputId = "ion-sel-" + F++),
              (this.didInit = !1),
              (this.isExpanded = !1),
              (this.disabled = !1),
          ...
          valueChanged() {
            this.emitStyle(),
              this.didInit && this.ionChange.emit({ value: this.value });
          }
          connectedCallback() {
            var e = this;
          ...
          open(e) {
            ...
            return (0, u.Z)(function* () {
              ...
              t.isExpanded = !0;
              const i = (t.overlay = yield t.createOverlay(e));
              if (
                (i.onDidDismiss().then(() => {
                  (t.overlay = void 0),
                    (t.isExpanded = !1),
                ...
                let n = t.childOpts.map((l) => l.value).indexOf(t.value);
                n = n > -1 ? n : 0;
                const o = i.querySelector(
                  `.select-interface-option:nth-child(${n + 1})`
                );
                o && (0, v.f)(o);
              }
              return i;
          ...
          createActionSheetButtons(e, t) {
            const i = e.map((n) => {
              const o = w(n),
                l = Array.from(n.classList)
                  .filter((c) => "hydrated" !== c)
                  .join(" "),
                p = `${S} ${l}`;
              return {
                role: g(t, o, this.compareWith) ? "selected" : "",
                text: n.textContent,
                cssClass: p,
                handler: () => {
                  this.value = o;
          ...
          createAlertInputs(e, t, i) {
            return e.map((o) => {
              ...
              return {
                ...
                label: o.textContent || "",
                value: l,
                checked: g(i, l, this.compareWith),
                disabled: o.disabled,
              };
            });
          }
          createPopoverOptions(e, t) {
            return e.map((n) => {
              ...
              return {
                ...
                cssClass: `${S} ${l}`,
                value: o,
                checked: g(t, o, this.compareWith),
                disabled: n.disabled,
                handler: (c) => {
                  (this.value = c), this.multiple || this.close();
                },
              };
            });
          }
          openPopover(e) {
            ...
            return (0, u.Z)(function* () {
              ...
              let c = e,
                m = "auto";
              const b = t.el.closest("ion-item");
              b &&
                (b.classList.contains("item-label-floating") ||
                  b.classList.contains("item-label-stacked")) &&
                ((c = Object.assign(Object.assign({}, e), {
                  detail: { ionShadowTarget: b },
                })),
                (m = "cover"));
              const I = Object.assign(
                ...
                ),
                {
                  ...
                  componentProps: {
                    ...
                    multiple: l,
                    value: p,
                    options: t.createPopoverOptions(t.childOpts, p),
                  },
                }
              );
              return x.c.create(I);
          ...
          openActionSheet() {
            ...
            return (0, u.Z)(function* () {
              const t = (0, f.b)(e),
                i = e.interfaceOptions,
                n = Object.assign(Object.assign({ mode: t }, i), {
                  buttons: e.createActionSheetButtons(e.childOpts, e.value),
                  cssClass: ["select-action-sheet", i.cssClass],
                });
              return x.b.create(n);
            })();
          }
          openAlert() {
            ...
            return (0, u.Z)(function* () {
              const t = e.getLabel(),
                ...
                n = e.interfaceOptions,
                o = e.multiple ? "checkbox" : "radio",
                l = (0, f.b)(e),
                p = Object.assign(Object.assign({ mode: l }, n), {
                  header: n.header ? n.header : i,
          ...
          getText() {
            ...
            return null != e && "" !== e
              ? e
              : B(this.childOpts, this.value, this.compareWith);
          }
          setFocus() {
          ...
          render() {
            const {
              ...
              c = (0, f.b)(this),
              { labelText: m, labelId: b } = (0, v.d)(t, i);
            (0, v.e)(!0, t, o, z(p), e);
            let T = !1,
              y = this.getText();
            "" === y && void 0 !== l && ((y = l), (T = !0));
            const K = { "select-text": !0, "select-placeholder": T },
              W = T ? "placeholder" : "text",
              L = void 0 !== m ? ("" !== y ? `${y}, ${m}` : m) : y;
            return (0, s.h)(
              s.H,
              {
                ...
                class: {
                  [c]: !0,
                  "in-item": (0, O.h)("ion-item", t),
                  "select-disabled": e,
                  "select-expanded": n,
                },
              },
              (0, s.h)("div", { "aria-hidden": "true", class: K, part: W }, y),
              (0, s.h)(
                "div",
                { class: "select-icon", role: "presentation", part: "icon" },
                (0, s.h)("div", { class: "select-icon-inner" })
              ),
              (0, s.h)("label", { id: b }, L),
              (0, s.h)("button", {
                type: "button",
        ...
        g = (e, t, i) =>
          void 0 !== e &&
          (Array.isArray(e) ? e.some((n) => A(n, t, i)) : A(e, t, i)),
        w = (e) => {
          const t = e.value;
        ...
        B = (e, t, i) =>
          void 0 === t
            ...
            : P(e, t, i) || "",
        P = (e, t, i) => {
          const n = e.find((o) => A(t, w(o), i));
          return n ? n.textContent : null;
        };
      let F = 0;
      const S = "select-interface-option";
      C.style = {
      ...
      let R = 0;
      j.style = ":host{display:none}";
      const D = class {
        constructor(e) {
          (0, s.r)(this, e), (this.options = []);
        }
        onSelect(e) {
          this.setChecked(e), this.callOptionHandler(e);
        }
        findOptionFromEvent(e) {
          const { options: t } = this;
          return t.find((i) => i.value === e.target.value);
        }
        callOptionHandler(e) {
          const t = this.findOptionFromEvent(e),
            i = this.getValues(e);
          t?.handler && (0, x.s)(t.handler, i);
        }
        rbClick(e) {
          this.callOptionHandler(e);
        }
        setChecked(e) {
          const { multiple: t } = this,
            i = this.findOptionFromEvent(e);
          t && i && (i.checked = e.detail.checked);
        }
        getValues(e) {
          const { multiple: t, options: i } = this;
          if (t) return i.filter((o) => o.checked).map((o) => o.value);
          const n = this.findOptionFromEvent(e);
        ...
        renderCheckboxOptions(e) {
          return e.map((t) =>
            (0, s.h)(
              ...
              (0, s.h)("ion-label", null, t.text)
            )
          );
        }
        renderRadioOptions(e) {
          const t = e.filter((i) => i.checked).map((i) => i.value)[0];
          return (0, s.h)(
            "ion-radio-group",
            { value: t },
            e.map((i) =>
              (0, s.h)(
                "ion-item",
                { class: (0, O.g)(i.cssClass) },
                (0, s.h)("ion-label", null, i.text),
                (0, s.h)("ion-radio", {
                  value: i.value,
                  disabled: i.disabled,
                  onClick: (n) => this.rbClick(n),
                })
              )
            )
          );
        ...
        render() {
          const { header: e, message: t, options: i, subHeader: n } = this,
            o = void 0 !== n || void 0 !== t;
          return (0, s.h)(
            s.H,
            { class: (0, f.b)(this) },
      ...
      D.style = {
        ios: ".sc-ion-select-popover-ios-h ion-list.sc-ion-select-popover-ios{margin-left:0;margin-right:0;margin-top:0;margin-bottom:0}ion-list-header.sc-ion-select-popover-ios,ion-label.sc-ion-select-popover-ios{margin-left:0;margin-right:0;margin-top:0;margin-bottom:0}",
        md: ".sc-ion-select-popover-md-h ion-list.sc-ion-select-popover-md{margin-left:0;margin-right:0;margin-top:0;margin-bottom:0}ion-list-header.sc-ion-select-popover-md,ion-label.sc-ion-select-popover-md{margin-left:0;margin-right:0;margin-top:0;margin-bottom:0}ion-list.sc-ion-select-popover-md ion-radio.sc-ion-select-popover-md{opacity:0}ion-item.sc-ion-select-popover-md{--inner-border-width:0}.item-radio-checked.sc-ion-select-popover-md{--background:rgba(var(--ion-color-primary-rgb, 56, 128, 255), 0.08);--background-focused:var(--ion-color-primary, #3880ff);--background-focused-opacity:0.2;--background-hover:var(--ion-color-primary, #3880ff);--background-hover-opacity:0.12}.item-checkbox-checked.sc-ion-select-popover-md{--background-activated:var(--ion-item-color, var(--ion-text-color, #000));--background-focused:var(--ion-item-color, var(--ion-text-color, #000));--background-hover:var(--ion-item-color, var(--ion-text-color, #000));--color:var(--ion-color-primary, #3880ff)}",
      };
    },
    2854: (M, _, h) => {
      h.d(_, { c: () => f, g: () => x, h: () => s, o: () => E });
      var u = h(5861);
      const s = (r, a) => null !== a.closest(r),
        f = (r, a) =>
          "string" == typeof r && r.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${r}`]: !0 }, a)
            : a,
        x = (r) => {
          const a = {};
          return (
        ...
        O = /^[a-z][a-z0-9+\-.]*:/,
        E = (function () {
          var r = (0, u.Z)(function* (a, d, k, C) {
            if (null != a && "#" !== a[0] && !O.test(a)) {
              const g = document.querySelector("ion-router");
              if (g) return d?.preventDefault(), g.push(a, k, C);
            }
            return !1;
          });
          return function (d, k, C, g) {
