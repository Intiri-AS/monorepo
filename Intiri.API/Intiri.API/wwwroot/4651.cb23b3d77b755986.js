...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [4651],
  {
    4147: (y, u, r) => {
      r.d(u, { a: () => f, b: () => e, p: () => m });
      const m = (h, ...p) => console.warn(`[Ionic Warning]: ${h}`, ...p),
        e = (h, ...p) => console.error(`[Ionic Error]: ${h}`, ...p),
        f = (h, ...p) =>
          console.error(
            `<${h.tagName.toLowerCase()}> must be used inside ${p.join(
              " or "
            )}.`
          );
    },
    2933: (y, u, r) => {
      ...
      const o = class {
        ...
        render() {
          const { disabled: t, expandable: i, href: n } = this,
            a = void 0 === n ? "button" : "a",
            d = (0, f.b)(this),
            g =
              "button" === a
            ...
            (0, e.h)(
              ...
              (0, e.h)(
                ...
                (0, e.h)(
                  ...
                  (0, e.h)("slot", { name: "icon-only" }),
                  (0, e.h)("slot", null),
                  (0, e.h)("slot", { name: "end" })
                ),
                (0, e.h)("slot", { name: "bottom" })
              ),
              "md" === d && (0, e.h)("ion-ripple-effect", null)
            )
          );
        }
        get el() {
      ...
      const S = class {
          constructor(t) {
            (0, e.r)(this, t),
              (this.ionDrag = (0, e.e)(this, "ionDrag", 7)),
              (this.item = null),
              (this.openAmount = 0),
          ...
          connectedCallback() {
            var t = this;
            return (0, m.Z)(function* () {
              (t.item = t.el.querySelector("ion-item")),
                (t.contentEl = (0, b.f)(t.el)),
          ...
          open(t) {
            var i = this;
            return (0, m.Z)(function* () {
              if (null === i.item) return;
              const n = i.getOptions(t);
              n &&
                (void 0 === t && (t = n === i.leftOptions ? "start" : "end"),
                (t = (0, p.o)(t) ? "end" : "start"),
                (i.openAmount < 0 && n === i.leftOptions) ||
                  (i.openAmount > 0 && n === i.rightOptions) ||
                  (i.closeOpened(),
                  (i.state = 4),
          ...
          closeOpened() {
            return (0, m.Z)(function* () {
              return void 0 !== c && (c.close(), (c = void 0), !0);
            })();
          }
          getOptions(t) {
            return void 0 === t
          ...
          updateOptions() {
            ...
            return (0, m.Z)(function* () {
              ...
              for (let a = 0; a < i.length; a++) {
                const d = i.item(a),
                  g =
                    void 0 !== d.componentOnReady
                      ? yield d.componentOnReady()
                      : d;
                "start" == ((0, p.o)(g.side) ? "end" : "start")
                  ? ((t.leftOptions = g), (n |= 1))
                  : ((t.rightOptions = g), (n |= 2));
              }
              (t.optsDirty = !0), (t.sides = n);
            })();
          }
          canStart(t) {
            return (
          ...
          onStart() {
            ...
            t && (this.initialContentScrollY = (0, b.d)(t)),
              (c = this.el),
              void 0 !== this.tmr &&
          ...
          onMove(t) {
            ...
            i > this.optsWidthRightSide
              ? ((n = this.optsWidthRightSide), (i = n + 0.55 * (i - n)))
              : i < -this.optsWidthLeftSide &&
                ((n = -this.optsWidthLeftSide), (i = n + 0.55 * (i - n))),
              this.setOpenAmount(i, !1);
          }
          onEnd(t) {
            const { contentEl: i, initialContentScrollY: n } = this;
            i && (0, b.r)(i, n);
            const a = t.velocityX;
            let d =
              this.openAmount > 0
            ...
            const g = this.openAmount > 0 == !(a < 0),
              E = Math.abs(a) > 0.3,
              z = Math.abs(this.openAmount) < Math.abs(d / 2);
            W(g, E, z) && (d = 0);
            const C = this.state;
            this.setOpenAmount(d, !0),
              0 != (32 & C) && this.rightOptions
          ...
          setOpenAmount(t, i) {
            if (
              ...
              return;
            const n = this.item.style;
            if (((this.openAmount = t), i && (n.transition = ""), t > 0))
    ...
    2854: (y, u, r) => {
      r.d(u, { c: () => f, g: () => p, h: () => e, o: () => k });
      var m = r(5861);
      const e = (s, o) => null !== o.closest(s),
        f = (s, o) =>
          "string" == typeof s && s.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${s}`]: !0 }, o)
            : o,
        p = (s) => {
          const o = {};
          return (
        ...
        b = /^[a-z][a-z0-9+\-.]*:/,
        k = (function () {
          var s = (0, m.Z)(function* (o, l, v, x) {
            if (null != o && "#" !== o[0] && !b.test(o)) {
              const w = document.querySelector("ion-router");
              if (w) return l?.preventDefault(), w.push(o, v, x);
            }
            return !1;
          });
          return function (l, v, x, w) {
