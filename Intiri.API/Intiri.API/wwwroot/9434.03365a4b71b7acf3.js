...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [9434],
  {
    9434: (_, g, a) => {
      ...
      const t = (i) => {
          ...
          return (
            ...
            d.addElement(i.querySelector(".loading-wrapper")).keyframes([
        ...
        y = class {
          constructor(i) {
            (0, n.r)(this, i),
              (this.didPresent = (0, n.e)(this, "ionLoadingDidPresent", 7)),
              (this.willPresent = (0, n.e)(this, "ionLoadingWillPresent", 7)),
              (this.willDismiss = (0, n.e)(this, "ionLoadingWillDismiss", 7)),
              (this.didDismiss = (0, n.e)(this, "ionLoadingDidDismiss", 7)),
              (this.presented = !1),
          ...
          componentWillLoad() {
            if (void 0 === this.spinner) {
              const i = (0, p.b)(this);
              this.spinner = p.c.get(
                "loadingSpinner",
                p.c.get("spinner", "ios" === i ? "lines" : "crescent")
              );
            }
          }
          present() {
            ...
            return (0, f.Z)(function* () {
              yield (0, c.d)(i, "loadingEnter", t, h, void 0),
                i.duration > 0 &&
          ...
          dismiss(i, l) {
            return (
              ...
              (0, c.f)(this, i, l, "loadingLeave", r, u)
            );
          }
          onDidDismiss() {
            return (0, c.g)(this.el, "ionLoadingDidDismiss");
          }
          onWillDismiss() {
            return (0, c.g)(this.el, "ionLoadingWillDismiss");
          }
          render() {
            const { message: i, spinner: l, htmlAttributes: s } = this,
              d = (0, p.b)(this);
            return (0, n.h)(
              n.H,
              Object.assign({ tabindex: "-1" }, s, {
              ...
              (0, n.h)(
                ...
                l &&
                  (0, n.h)(
                    ...
                    (0, n.h)("ion-spinner", { name: l, "aria-hidden": "true" })
                  ),
                void 0 !== i &&
                  (0, n.h)("div", {
    ...
    2854: (_, g, a) => {
      a.d(g, { c: () => p, g: () => x, h: () => n, o: () => e });
      var f = a(5861);
      const n = (o, t) => null !== t.closest(o),
        p = (o, t) =>
        ...
        b = /^[a-z][a-z0-9+\-.]*:/,
        e = (function () {
          var o = (0, f.Z)(function* (t, r, h, u) {
            if (null != t && "#" !== t[0] && !b.test(t)) {
              const m = document.querySelector("ion-router");
              if (m) return r?.preventDefault(), m.push(t, h, u);
            }
            return !1;
          });
          return function (r, h, u, m) {
