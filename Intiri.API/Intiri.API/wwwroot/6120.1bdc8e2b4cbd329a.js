  ...
  [6120],
  {
    6120: (D, x, d) => {
      ...
      const l = (t, o) => {
          const e = (0, u.c)(),
            n = (0, u.c)(),
            p = (0, r.g)(t).querySelector(".toast-wrapper");
          switch ((n.addElement(p), o)) {
            case "top":
              n.fromTo(
                "transform",
                "translateY(-100%)",
              ...
              break;
            case "middle":
              const _ = Math.floor(t.clientHeight / 2 - p.clientHeight / 2);
              (p.style.top = `${_}px`), n.fromTo("opacity", 0.01, 1);
              break;
            default:
              n.fromTo(
                "transform",
        ...
        y = (t, o) => {
          ...
          switch ((n.addElement(p), o)) {
            case "top":
              (p.style.top = "calc(8px + var(--ion-safe-area-top, 0px))"),
            ...
            case "middle":
              ...
              break;
            default:
              (p.style.bottom = "calc(8px + var(--ion-safe-area-bottom, 0px))"),
                n.fromTo("opacity", 0.01, 1);
          }
          return e
            .easing("cubic-bezier(.36,.66,.04,1)")
        ...
        b = (t) => {
          const o = (0, u.c)(),
            e = (0, u.c)(),
            a = (0, r.g)(t).querySelector(".toast-wrapper");
          return (
            e.addElement(a).fromTo("opacity", 0.99, 0),
            o
              .easing("cubic-bezier(.36,.66,.04,1)")
              .duration(300)
              .addAnimation(e)
        ...
        E = class {
          constructor(t) {
            (0, i.r)(this, t),
              (this.didPresent = (0, i.e)(this, "ionToastDidPresent", 7)),
              (this.willPresent = (0, i.e)(this, "ionToastWillPresent", 7)),
              (this.willDismiss = (0, i.e)(this, "ionToastWillDismiss", 7)),
              (this.didDismiss = (0, i.e)(this, "ionToastDidDismiss", 7)),
              (this.presented = !1),
              (this.duration = 0),
              ...
              (this.translucent = !1),
              (this.animated = !0),
              (this.dispatchCancelHandler = (o) => {
                if ((0, c.i)(o.detail.role)) {
                  const n = this.getButtons().find((a) => "cancel" === a.role);
          ...
          present() {
            ...
            return (0, g.Z)(function* () {
              yield (0, c.d)(t, "toastEnter", l, y, t.position),
                t.duration > 0 &&
          ...
          dismiss(t, o) {
            return (
              ...
              (0, c.f)(this, t, o, "toastLeave", v, b, this.position)
            );
          }
          onDidDismiss() {
            return (0, c.g)(this.el, "ionToastDidDismiss");
          }
          onWillDismiss() {
            return (0, c.g)(this.el, "ionToastWillDismiss");
          }
          getButtons() {
            return this.buttons
              ? this.buttons.map((o) =>
          ...
          buttonClick(t) {
            ...
            return (0, g.Z)(function* () {
              const e = t.role;
              return (0, c.i)(e) || (yield o.callButtonHandler(t))
                ? o.dismiss(void 0, e)
                : Promise.resolve();
            })();
          }
                ...
                (0, i.h)(
                  ...
                  (0, i.h)(
                    ...
                    a.icon &&
                      (0, i.h)("ion-icon", {
                        icon: a.icon,
                        slot: void 0 === a.text ? "icon-only" : void 0,
          ...
          render() {
            const t = this.getButtons(),
              o = t.filter((h) => "start" === h.side),
              e = t.filter((h) => "start" !== h.side),
              n = (0, w.b)(this),
              a = { "toast-wrapper": !0, [`toast-${this.position}`]: !0 };
            return (0, i.h)(
              i.H,
              Object.assign(
                {
                ...
                this.htmlAttributes,
                {
                  ...
                  class: (0, m.c)(
                    this.color,
                    Object.assign(
                      Object.assign({ [n]: !0 }, (0, m.g)(this.cssClass)),
                      {
                        "overlay-hidden": !0,
                ...
                (0, i.h)(
                  ...
                  (0, i.h)(
                    ...
                    void 0 !== this.header &&
                      (0, i.h)(
                        "div",
                        { class: "toast-header", part: "header" },
                        this.header
                      ),
                    void 0 !== this.message &&
                      (0, i.h)("div", {
    ...
    2854: (D, x, d) => {
      ...
      const i = (r, s) => null !== s.closest(r),
        ...
        m = /^[a-z][a-z0-9+\-.]*:/,
        u = (function () {
          var r = (0, g.Z)(function* (s, l, v, y) {
            if (null != s && "#" !== s[0] && !m.test(s)) {
              const b = document.querySelector("ion-router");
              if (b) return l?.preventDefault(), b.push(s, v, y);
            }
            return !1;
          });
          return function (l, v, y, b) {
