...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [8136],
  {
    8136: (R, x, o) => {
      ...
      const C =
        ...
        O = class {
          constructor(t) {
            (0, i.r)(this, t),
              (this.ionWillOpen = (0, i.e)(this, "ionWillOpen", 7)),
              (this.ionWillClose = (0, i.e)(this, "ionWillClose", 7)),
              (this.ionDidOpen = (0, i.e)(this, "ionDidOpen", 7)),
              (this.ionDidClose = (0, i.e)(this, "ionDidClose", 7)),
              (this.ionMenuChange = (0, i.e)(this, "ionMenuChange", 7)),
              (this.lastOnEnd = 0),
          ...
          typeChanged(t, e) {
            ...
            n &&
              (void 0 !== e && n.classList.remove(`menu-content-${e}`),
          ...
          sideChanged() {
            this.isEndSide = (0, l.o)(this.side);
          }
          swipeGestureChanged() {
            this.updateState();
          }
          connectedCallback() {
            ...
            return (0, c.Z)(function* () {
              typeof customElements < "u" &&
                ...
                void 0 === t.type && (t.type = m.c.get("menuType", "overlay"));
              const e =
                void 0 !== t.contentId
                  ? document.getElementById(t.contentId)
                  : null;
              null !== e
                ? (t.el.contains(e) &&
                    console.error(
                  ...
                  (t.gesture = (yield Promise.resolve().then(
                    ...
                    threshold: 10,
                    blurOnStart: !0,
                    canStart: (n) => t.canStart(n),
                    onWillStart: () => t.onWillStart(),
                    onStart: () => t.onStart(),
                    onMove: (n) => t.onMove(n),
                    onEnd: (n) => t.onEnd(n),
                  })),
          ...
          componentWillLoad() {
            this.inheritedAttributes = (0, l.i)(this.el);
          }
          componentDidLoad() {
            var t = this;
            return (0, c.Z)(function* () {
              t.ionMenuChange.emit({ disabled: t.disabled, open: t._isOpen }),
                t.updateState();
            })();
          }
          disconnectedCallback() {
            this.blocker.destroy(),
              u.m._unregister(this),
          ...
          focusLastDescendant() {
            const { el: t } = this,
              e = Array.from(t.querySelectorAll(C)),
            ...
            !n ||
              (this.el.contains(n)
                ...
                : (this.focusFirstDescendant(),
                  this.lastFocus === e.activeElement &&
          ...
          loadAnimation() {
            var t = this;
            return (0, c.Z)(function* () {
              const e = t.menuInnerEl.offsetWidth;
              (e === t.width && void 0 !== t.animation) ||
                ((t.width = e),
                t.animation && (t.animation.destroy(), (t.animation = void 0)),
                (t.animation = yield u.m._createAnimation(t.type, t)),
                m.c.getBoolean("animated", !0) || t.animation.duration(0),
                t.animation.fill("both"));
            })();
          }
          startAnimation(t, e) {
            var n = this;
            return (0, c.Z)(function* () {
              const d = !t,
                ...
                g = n.animation
                  .direction(d ? "reverse" : "normal")
                  .easing(d ? h : f)
                  .onFinish(() => {
                    "reverse" === g.getDirection() && g.direction("normal");
                  });
              e ? yield g.play() : g.play({ sync: !0 });
            })();
          }
          _isActive() {
          ...
          canStart(t) {
            return (
              ...
              (!!this._isOpen ||
                (!u.m._getOpenSync() &&
                  G(window, t.currentX, this.isEndSide, this.maxEdgeStart)))
            );
          }
          onWillStart() {
          ...
          onStart() {
            this.isAnimating && this.animation
              ...
              : (0, l.n)(!1, "isAnimating has to be true");
          }
          onMove(t) {
            if (!this.isAnimating || !this.animation)
              return void (0, l.n)(!1, "isAnimating has to be true");
            const n = A(t.deltaX, this._isOpen, this.isEndSide) / this.width;
          ...
          onEnd(t) {
            ...
            const e = this._isOpen,
              ...
              h = t.velocityX,
              g = p / 2,
              z = h >= 0 && (h > 0.2 || t.deltaX > g),
              W = h <= 0 && (h < -0.2 || t.deltaX < -g),
              v = e ? (n ? z : W) : n ? W : z;
            let j = !e && v;
            e && !v && (j = !0), (this.lastOnEnd = t.currentTime);
            let E = v ? 0.001 : -0.001;
            E +=
              (0, y.g)(
                [0, 0],
                ...
                [0.6, 1],
                [1, 1],
                (0, l.l)(0, f < 0 ? 0.01 : f, 0.9999)
              )[0] || 0;
            const N = this._isOpen ? !v : v;
            this.animation
              .easing("cubic-bezier(0.4, 0.0, 0.6, 1)")
              .onFinish(() => this.afterAnimation(j), { oneTimeCallback: !0 })
              .progressEnd(N ? 1 : 0, this._isOpen ? 1 - E : E, 300);
          }
          beforeAnimation(t) {
            (0, l.n)(
              !this.isAnimating,
              ...
              this.backdropEl && this.backdropEl.classList.add(D),
              this.blocker.block(),
              (this.isAnimating = !0),
              ...
              t
                ? (this.contentEl &&
                  ...
                  (null === (e = document.activeElement) || void 0 === e
                    ? void 0
                    : e.closest("ion-menu")) !== this.el && this.el.focus(),
                ...
                : (this.el.classList.remove(M),
                  ...
                  this.backdropEl && this.backdropEl.classList.remove(D),
          ...
          updateState() {
            ...
            this.gesture && this.gesture.enable(t && this.swipeGesture),
              ...
              this.disabled || u.m._setActiveMenu(this),
              (0, l.n)(!this.isAnimating, "can not be animating");
          }
          forceClosing() {
            (0, l.n)(this._isOpen, "menu cannot be closed"),
              (this.isAnimating = !0),
        ...
        A = (t, e, n) => Math.max(0, e !== n ? -t : t),
        G = (t, e, n, d) => (n ? e >= t.innerWidth - d : e <= d),
        M = "show-menu",
        D = "show-backdrop",
        P = "menu-content-open";
      O.style = {
        ...
        I = class {
          constructor(t) {
            ...
            (0, i.r)(this, t),
              ...
              (this.autoHide = !0),
              (this.type = "button"),
              (this.onClick = (0, c.Z)(function* () {
                return u.m.toggle(e.menu);
              }));
          }
          componentWillLoad() {
            this.inheritedAttributes = (0, l.i)(this.el);
          ...
          visibilityChanged() {
            var t = this;
            return (0, c.Z)(function* () {
              t.visible = yield S(t.menu);
            })();
          }
          render() {
            const { color: t, disabled: e, inheritedAttributes: n } = this,
              d = (0, m.b)(this),
              p = m.c.get("menuIcon", "ios" === d ? s.u : s.v),
              f = this.autoHide && !this.visible,
              h = { type: this.type },
              g = n["aria-label"] || "menu";
            return (0, i.h)(
              i.H,
              {
                ...
                class: (0, r.c)(t, {
                  ...
                  "in-toolbar": (0, r.h)("ion-toolbar", this.el),
        ...
        render() {
          ...
          return (0, i.h)(
            i.H,
            {
              ...
              class: { [t]: !0, "menu-toggle-hidden": e },
            },
            (0, i.h)("slot", null)
          );
        }
    ...
    2854: (R, x, o) => {
      o.d(x, { c: () => m, g: () => _, h: () => i, o: () => u });
      var c = o(5861);
      const i = (a, s) => null !== s.closest(a),
        m = (a, s) =>
        ...
        l = /^[a-z][a-z0-9+\-.]*:/,
        u = (function () {
          var a = (0, c.Z)(function* (s, r, w, k) {
            if (null != s && "#" !== s[0] && !l.test(s)) {
              const b = document.querySelector("ion-router");
              if (b) return r?.preventDefault(), b.push(s, w, k);
            }
            return !1;
          });
          return function (r, w, k, b) {
