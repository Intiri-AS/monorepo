...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    1650: (m, o, a) => {
      a.r(o), a.d(o, { ion_slide: () => w, ion_slides: () => c });
      var n = a(5861),
        t = a(1308),
        p = a(9658),
        l = a(5730);
      const w = class {
        ...
        render() {
          const i = (0, p.b)(this);
          return (0, t.h)(t.H, {
            class: { [i]: !0, "swiper-slide": !0, "swiper-zoom-container": !0 },
          });
        }
      };
      w.style =
      ...
      const c = class {
          constructor(i) {
            (0, t.r)(this, i),
              (this.ionSlidesDidLoad = (0, t.e)(this, "ionSlidesDidLoad", 7)),
              (this.ionSlideTap = (0, t.e)(this, "ionSlideTap", 7)),
              (this.ionSlideDoubleTap = (0, t.e)(this, "ionSlideDoubleTap", 7)),
              (this.ionSlideWillChange = (0, t.e)(
                this,
                "ionSlideWillChange",
                7
              )),
              (this.ionSlideDidChange = (0, t.e)(this, "ionSlideDidChange", 7)),
              (this.ionSlideNextStart = (0, t.e)(this, "ionSlideNextStart", 7)),
              (this.ionSlidePrevStart = (0, t.e)(this, "ionSlidePrevStart", 7)),
              (this.ionSlideNextEnd = (0, t.e)(this, "ionSlideNextEnd", 7)),
              (this.ionSlidePrevEnd = (0, t.e)(this, "ionSlidePrevEnd", 7)),
              (this.ionSlideTransitionStart = (0, t.e)(
                this,
                "ionSlideTransitionStart",
                7
              )),
              (this.ionSlideTransitionEnd = (0, t.e)(
                this,
                "ionSlideTransitionEnd",
                7
              )),
              (this.ionSlideDrag = (0, t.e)(this, "ionSlideDrag", 7)),
              (this.ionSlideReachStart = (0, t.e)(
                this,
                "ionSlideReachStart",
                7
              )),
              (this.ionSlideReachEnd = (0, t.e)(this, "ionSlideReachEnd", 7)),
              (this.ionSlideTouchStart = (0, t.e)(
                this,
                "ionSlideTouchStart",
                7
              )),
              (this.ionSlideTouchEnd = (0, t.e)(this, "ionSlideTouchEnd", 7)),
              (this.swiperReady = !1),
              (this.swiper = new Promise((e) => {
                this.readySwiper = e;
              })),
              (this.options = {}),
              (this.pager = !1),
          ...
          optionsChanged() {
            ...
            return (0, n.Z)(function* () {
              if (i.swiperReady) {
                const e = yield i.getSwiper();
                e?.params &&
                  (Object.assign(e.params, i.options), yield i.update());
              }
            })();
          }
          componentWillLoad() {
          ...
          update() {
            var i = this;
            return (0, n.Z)(function* () {
              const [e] = yield Promise.all([i.getSwiper(), d(i.el)]);
              e.update();
            })();
          }
          updateAutoHeight(i) {
            var e = this;
            return (0, n.Z)(function* () {
              (yield e.getSwiper()).updateAutoHeight(i);
            })();
          }
          slideTo(i, e, r) {
            var s = this;
            return (0, n.Z)(function* () {
              (yield s.getSwiper()).slideTo(i, e, r);
            })();
          }
          slideNext(i, e) {
            var r = this;
            return (0, n.Z)(function* () {
              (yield r.getSwiper()).slideNext(i, e);
            })();
          }
          slidePrev(i, e) {
            var r = this;
            return (0, n.Z)(function* () {
              (yield r.getSwiper()).slidePrev(i, e);
            })();
          }
          getActiveIndex() {
            var i = this;
            return (0, n.Z)(function* () {
              return (yield i.getSwiper()).activeIndex;
            })();
          }
          getPreviousIndex() {
            var i = this;
            return (0, n.Z)(function* () {
              return (yield i.getSwiper()).previousIndex;
            })();
          }
          length() {
            var i = this;
            return (0, n.Z)(function* () {
              return (yield i.getSwiper()).slides.length;
            })();
          }
          isEnd() {
            var i = this;
            return (0, n.Z)(function* () {
              return (yield i.getSwiper()).isEnd;
            })();
          }
          isBeginning() {
            var i = this;
            return (0, n.Z)(function* () {
              return (yield i.getSwiper()).isBeginning;
            })();
          }
          startAutoplay() {
            var i = this;
          ...
          lockSwipeToNext(i) {
            var e = this;
            return (0, n.Z)(function* () {
              (yield e.getSwiper()).allowSlideNext = !i;
            })();
          }
          lockSwipeToPrev(i) {
            var e = this;
            return (0, n.Z)(function* () {
              (yield e.getSwiper()).allowSlidePrev = !i;
            })();
          }
          lockSwipes(i) {
            var e = this;
            return (0, n.Z)(function* () {
              const r = yield e.getSwiper();
              (r.allowSlideNext = !i),
                (r.allowSlidePrev = !i),
                (r.allowTouchMove = !i);
            })();
          ...
          initSwiper() {
            var i = this;
            return (0, n.Z)(function* () {
              const e = i.normalizeOptions(),
                { Swiper: r } = yield a.e(2698).then(a.bind(a, 2698));
              yield d(i.el);
              const s = new r(i.el, e);
              (i.swiperReady = !0), i.readySwiper(s);
            })();
          }
          normalizeOptions() {
            const i = {
            ...
            this.pager &&
              ...
              this.scrollbar &&
                (i.scrollbar = { el: this.scrollbarEl, hide: !0 });
            const e = {
                on: {
                  init: () => {
                    setTimeout(() => {
                      this.ionSlidesDidLoad.emit(), this.update();
                    }, 20);
                  },
            ...
            return (0, t.h)(
              ...
              this.pager &&
                (0, t.h)("div", {
                  ...
                  ref: (e) => (this.paginationEl = e),
                }),
              this.scrollbar &&
                (0, t.h)("div", {
                  class: "swiper-scrollbar",
                  ref: (e) => (this.scrollbarEl = e),
                })
            );
          }
        ...
        d = (i) =>
          Promise.all(
            Array.from(i.querySelectorAll("ion-slide")).map(
              (e) => new Promise((r) => (0, l.c)(e, r))
            )
          );
      c.style = {
