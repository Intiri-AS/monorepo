    ...
    2698: (ws, re, ae) => {
      ...
      const de = {
        addClass: function me(e) {
          ...
          for (let s = 0; s < t.length; s += 1)
            for (let i = 0; i < this.length; i += 1)
              typeof this[i] < "u" &&
                typeof this[i].classList < "u" &&
                this[i].classList.add(t[s]);
          return this;
        },
              ...
              if (
                ...
                for (let u = d.length - 1; u >= 0; u -= 1) {
                  ...
                  (i &&
                    ...
                    ? (c.removeEventListener(l, p.proxyListener, n),
                      d.splice(u, 1))
                    : i ||
                      (c.removeEventListener(l, p.proxyListener, n),
                      d.splice(u, 1));
        ...
        transitionEnd: function Me(e) {
          ...
          function n(r) {
            if (r.target === this)
              for (e.call(this, r), i = 0; i < t.length; i += 1) s.off(t[i], n);
          }
        ...
        offset: function ze() {
          if (this.length > 0) {
            ...
            return {
              top:
                t.top +
                (e === h ? h.scrollY : e.scrollTop) -
                (e.clientTop || s.clientTop || 0),
              left:
                t.left +
                (e === h ? h.scrollX : e.scrollLeft) -
        ...
        html: function Be(e) {
          if (typeof e > "u") return this[0] ? this[0].innerHTML : void 0;
        ...
        eq: function He(e) {
          ...
          return e > t - 1
            ? new C([])
            : e < 0
            ? ((s = t + e), new C(s < 0 ? [] : [this[s]]))
            : new C([this[e]]);
        },
        append: function Ye(...e) {
          let t;
          for (let s = 0; s < e.length; s += 1) {
            t = e[s];
            for (let i = 0; i < this.length; i += 1)
              if ("string" == typeof t) {
                ...
                for (let n = 0; n < t.length; n += 1) this[i].appendChild(t[n]);
        ...
        children: function _e(e) {
          ...
          for (let s = 0; s < this.length; s += 1) {
            ...
            for (let n = 0; n < i.length; n += 1)
              e
                ? 1 === i[n].nodeType && w(i[n]).is(e) && t.push(i[n])
      ...
      const g = {
          ...
          extend(...e) {
            ...
            for (let i = 1; i < e.length; i += 1) {
              const n = e[i];
              if (null != n) {
                const r = Object.keys(Object(n)).filter(
                  (a) => s.indexOf(a) < 0
                );
        ...
        y = {
          touch: !!(
            "ontouchstart" in h ||
            (h.DocumentTouch && T instanceof h.DocumentTouch)
          ),
          pointerEvents:
            !!h.PointerEvent &&
      ...
      class ce {
                ...
                typeof s > "u"
                  ...
                  : i.eventsListeners[n] &&
                    ...
                    i.eventsListeners[n].forEach((r, a) => {
                      (r === s || (r.f7proxy && r.f7proxy === s)) &&
                        i.eventsListeners[n].splice(a, 1);
                    });
              }),
            i
          );
        ...
        static use(t, ...s) {
          ...
          return Array.isArray(t)
            ? (t.forEach((n) => i.installModule(n)), i)
            : i.installModule(t, ...s);
        }
      }
      var ot = {
          updateSize: function Je() {
            ...
            const i = e.$el;
            (t =
              typeof e.params.width < "u" ? e.params.width : i[0].clientWidth),
              (s =
              ...
              if (t.slidesPerColumn > 1) {
                ...
                if ("row" === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                  const Y = Math.floor(
                    ...
                    W = S - t.slidesPerColumn * t.slidesPerGroup * Y,
                    F =
                      0 === Y
                        ? t.slidesPerGroup
                        : Math.min(
                            Math.ceil((c - Y * z * t.slidesPerGroup) / z),
                            t.slidesPerGroup
                          );
                  (O = Math.floor(W / F)),
                    (I = W - O * F + Y * t.slidesPerGroup),
                    ($ = I + (O * D) / z),
                    P.css({
              ...
              if ("none" !== P.css("display")) {
                if ("auto" === t.slidesPerView) {
                  ...
                  if (
                    ...
                    const Y = parseFloat($.getPropertyValue("width")),
                    ...
                    M = j && "border-box" === j ? Y + R + N : Y + W + F + R + N;
                  } else {
                    const Y = parseFloat($.getPropertyValue("height")),
                  ...
                  (M = (i - (t.slidesPerView - 1) * x) / t.slidesPerView),
                    ...
                    o[S] &&
                      (e.isHorizontal()
                        ? (o[S].style.width = `${M}px`)
                        : (o[S].style.height = `${M}px`));
            ...
            if (
              ...
              for (let S = 0; S < d.length; S += 1) {
                ...
                t.roundLengths && (P = Math.floor(P)),
                  d[S] < e.virtualSize + d[0] && V.push(P);
              }
              d = V;
            }
            if (!t.centeredSlides) {
            ...
            s.isHorizontal() ? (o = i ? -e : e) : (c = e),
              ...
              n.cssMode
                ? (a[s.isHorizontal() ? "scrollLeft" : "scrollTop"] =
                    s.isHorizontal() ? -o : -c)
                : n.virtualTranslate ||
                  r.transform(`translate3d(${o}px, ${c}px, 0px)`),
        ...
        $t = {
          slideTo: function bt(e = 0, t = this.params.speed, s = !0, i) {
            ...
            if ((n.updateProgress(m), a.normalizeSlideIndex))
              for (let E = 0; E < o.length; E += 1)
                -Math.floor(100 * m) >= Math.floor(100 * o[E]) && (r = E);
            if (
              n.initialized &&
              r !== d &&
            ...
            if (
              ...
              return (
                ...
                "reset" !== L &&
                  (n.transitionStart(s, L), n.transitionEnd(s, L)),
                !1
              );
            if (a.cssMode) {
          ...
          slidePrev: function yt(e = this.params.speed, t = !0, s) {
            ...
            return (
              ...
              typeof f < "u" &&
                ((v = l.indexOf(f)), v < 0 && (v = i.activeIndex - 1)),
              i.slideTo(v, e, t, s)
            );
          },
          ...
          loopCreate: function Mt() {
            ...
            if (t.loopFillGroupWithBlank) {
              ...
              if (a !== t.slidesPerGroup) {
                for (let l = 0; l < a; l += 1) {
                  const o = w(T.createElement("div")).addClass(
          ...
          (i.webView =
            !(
              ...
              (!s.match(/.*AppleWebKit(?!.*Safari)/i) &&
                !h.navigator.standalone)
            ) ||
            (h.matchMedia &&
              h.matchMedia("(display-mode: standalone)").matches)),
          (i.webview = i.webView),
      ...
      function Vt(e) {
        ...
        if (a.preventedByNestedSwiper)
          return (n.startX = o), void (n.startY = c);
        if (!t.allowTouchMove)
          return (
            (t.allowClick = !1),
            void (
              s.isTouched &&
              (g.extend(n, { startX: o, startY: c, currentX: o, currentY: c }),
              (s.touchStartTime = g.now()))
            )
          );
            ...
            ? ((f = !1),
              i.resistance &&
                (s.currentTranslate =
                  t.minTranslate() -
                  1 +
                  (-t.minTranslate() + s.startTranslate + p) ** v))
            : p < 0 &&
              ...
              i.resistance &&
                (s.currentTranslate =
                  t.maxTranslate() +
                  1 -
                  (t.maxTranslate() - s.startTranslate - p) ** v)),
      ...
      function Wt(e) {
        ...
        if (i.freeMode) {
          ...
          if (p > -t.maxTranslate())
            return void t.slideTo(
              t.slides.length < o.length ? o.length - 1 : t.slides.length - 1
            );
          if (i.freeModeMomentum) {
            ...
            if (b < t.maxTranslate())
              ...
              (b =
                Math.abs(o[z] - b) < Math.abs(o[z - 1] - b) ||
                "next" === t.swipeDirection
                  ? o[z]
                  : o[z - 1]),
                (b = -b);
        ...
        if (u > i.longSwipesMs) {
          ...
          "next" === t.swipeDirection &&
            t.slideTo(m >= i.longSwipesRatio ? f + L : f),
            "prev" === t.swipeDirection &&
              t.slideTo(m > 1 - i.longSwipesRatio ? f + L : f);
        } else {
          if (!i.shortSwipes) return void t.slideTo(t.activeIndex);
          !t.navigation ||
          (c.target !== t.navigation.nextEl && c.target !== t.navigation.prevEl)
            ? ("next" === t.swipeDirection && t.slideTo(f + L),
                ...
                d && !u
                  ...
                  : !d &&
                    ...
                    "column" === c.slidesPerColumnFill &&
                      r.addClass(`${n.containerModifierClass}multirow-column`));
        ...
        constructor(...t) {
          ...
          return (
            ...
            s && s.shadowRoot && s.shadowRoot.querySelector
              ? ((l = w(
                  s.shadowRoot.querySelector(`.${n.params.wrapperClass}`)
                )),
                (l.children = (o) => a.children(o)))
            ...
            g.extend(n, {
              ...
              rtl:
                "rtl" === s.dir.toLowerCase() || "rtl" === a.css("direction"),
              rtlTranslate:
              ...
              touchEvents: (function () {
                ...
                return (
                  ...
                  y.touch || !n.params.simulateTouch
                    ? n.touchEventsTouch
                    : n.touchEventsDesktop
                );
              })(),
        ...
        slidesPerViewDynamic() {
          ...
          if (s.centeredSlides) {
            ...
            for (let d = a + 1; d < i.length; d += 1)
              i[d] &&
                !c &&
                ((o += i[d].swiperSlideSize), (l += 1), o > r && (c = !0));
      ...
      const q = {
        ...
        attach(e, t = {}) {
          ...
          n.observe(e, {
            attributes: typeof t.attributes > "u" || t.attributes,
            childList: typeof t.childList > "u" || t.childList,
            characterData: typeof t.characterData > "u" || t.characterData,
          }),
            ...
            if (
                ...
                l.each((u, p) => {
                  ...
                  v === r && f.addClass(s.bulletActiveClass),
                    s.dynamicBullets &&
                      (v >= o &&
                        v <= c &&
                        f.addClass(`${s.bulletActiveClass}-main`),
                      v === o &&
                        f
                          .prev()
                  ...
                  if (e.params.loop)
                    if (p >= l.length - s.dynamicMainBullets) {
                      for (let m = s.dynamicMainBullets; m >= 0; m -= 1)
                        l.eq(l.length - m).addClass(
                          `${s.bulletActiveClass}-main`
                        );
                      l.eq(l.length - s.dynamicMainBullets - 1).addClass(
              ...
              if (s.dynamicBullets) {
                const u = Math.min(l.length, s.dynamicMainBullets + 4),
                  p =
                    (e.pagination.bulletSize * u - e.pagination.bulletSize) /
                      2 -
      ...
      var fs = {
        ...
        on: {
          ...
          activeIndexChange() {
            const e = this;
            (e.params.loop || typeof e.snapIndex > "u") &&
              e.pagination.update();
          },
          snapIndexChange() {
      ...
      const ne = {
        ...
        onGestureStart(e) {
          ...
          if (
            ...
            (i.fakeGestureTouched = !0),
              (n.scaleStart = ne.getDistanceBetweenTouches(e));
          }
        ...
        onGestureChange(e) {
          ...
          if (!y.gestures) {
            ...
            (i.fakeGestureMoved = !0),
              (n.scaleMove = ne.getDistanceBetweenTouches(e));
          }
          !n.$imageEl ||
            0 === n.$imageEl.length ||
            ((i.scale = y.gestures
        ...
        in(e) {
          ...
          if (
            ...
            return;
          let a, l, o, c, d, u, p, f, v, m, L, E, x, b, H, B, D, M;
          n.$slideEl.addClass(`${i.zoomedSlideClass}`),
            typeof r.touchesStart.x > "u" && e
              ? ((a =
            ...
            n.$imageWrapEl
              .transition(300)
              .transform(`translate3d(${p}px, ${f}px,0)`),
            n.$imageEl
              .transition(300)
          ...
          y.gestures
            ...
            : "touchstart" === e.touchEvents.start &&
              ...
              e.touchEvents.cancel &&
                e.$wrapperEl.on(e.touchEvents.cancel, n, t.onGestureEnd, s)),
            e.$wrapperEl.on(
              e.touchEvents.move,
        ...
        disable() {
          ...
          y.gestures
            ...
            : "touchstart" === e.touchEvents.start &&
              ...
              e.touchEvents.cancel &&
                e.$wrapperEl.off(e.touchEvents.cancel, n, t.onGestureEnd, s)),
            e.$wrapperEl.off(
              e.touchEvents.move,
              `.${e.params.zoom.containerClass}`,
              t.onTouchMove,
