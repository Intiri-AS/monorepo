...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [1217],
  {
      ...
      const n = class {
        constructor(t) {
          (0, o.r)(this, t),
            ...
            (this.onInput = (i) => {
              const s = i.target;
              s && (this.value = s.value || ""), this.ionInput.emit(i);
            }),
            (this.onBlur = (i) => {
              (this.hasFocus = !1),
                this.focusChanged(),
                this.emitStyle(),
                this.fireFocusEvents && this.ionBlur.emit(i);
            }),
            (this.onFocus = (i) => {
              (this.hasFocus = !0),
                this.focusChanged(),
                this.emitStyle(),
                this.fireFocusEvents && this.ionFocus.emit(i);
            }),
            (this.onKeydown = (i) => {
            ...
            (this.clearTextInput = (i) => {
              this.clearInput &&
                ...
                !this.disabled &&
                i &&
                (i.preventDefault(), i.stopPropagation(), this.setFocus()),
                (this.value = ""),
                this.nativeInput && (this.nativeInput.value = "");
            });
        }
        debounceChanged() {
          this.ionChange = (0, r.h)(this.ionChange, this.debounce);
        }
        disabledChanged() {
          this.emitStyle();
        }
        ...
        valueChanged() {
          const t = this.nativeInput,
            i = this.getValue();
          t && t.value !== i && !this.isComposing && (t.value = i),
            this.emitStyle(),
            this.ionChange.emit({
        ...
        componentWillLoad() {
          this.inheritedAttributes = Object.assign(
            Object.assign({}, (0, r.i)(this.el)),
            (0, r.j)(this.el, ["tabindex", "title", "data-form-type"])
          );
        }
        connectedCallback() {
          this.emitStyle(),
        ...
        disconnectedCallback() {
          ...
          const t = this.nativeInput;
          t &&
            (t.removeEventListener("compositionstart", this.onCompositionStart),
    ...
    2854: (f, p, a) => {
      a.d(p, { c: () => c, g: () => h, h: () => o, o: () => m });
      var d = a(5861);
      const o = (n, e) => null !== e.closest(n),
        c = (n, e) =>
          "string" == typeof n && n.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${n}`]: !0 }, e)
            : e,
        h = (n) => {
          const e = {};
          return (
        ...
        u = /^[a-z][a-z0-9+\-.]*:/,
        m = (function () {
          var n = (0, d.Z)(function* (e, t, i, s) {
            if (null != e && "#" !== e[0] && !u.test(e)) {
              const l = document.querySelector("ion-router");
              if (l) return t?.preventDefault(), l.push(e, i, s);
            }
            return !1;
          });
